...
export function ShareListModal({ isOpen, onClose, title, entries }: ShareListModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} width={600}>
      ...
      >
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <h2
            ...
            style={{ fontSize: 18, fontWeight: 700, color: "var(--apple-label)", margin: 0 }}
          >
            Share & Export: {title}
          </h2>
        </div>
      ...
      {/* Content Body */}
      <div style={{ padding: "var(--space-6)", overflowY: "auto", flex: 1, maxHeight: "60vh" }}>
        {tab === "markdown" && (
          <div>
            <p
              style={{
            ...
            >
              Copy formatted Markdown checklist with star ratings and completion status ready to
              paste into Reddit, Discord, or GitHub.
            </p>
            <textarea
              readOnly
              value={markdownText}
          ...
          <div style={{ textAlign: "center" }}>
            ...
            {generatingImg && (
              ...
              >
                ...
                <span style={{ fontSize: 14, color: "var(--apple-secondary-label)" }}>
                  Generating collage card…
                </span>
              </div>
            )}
        ...
        {tab === "calendar" && (
          <div>
            ...
            >
              Export an Apple Calendar, Google Calendar, or Outlook compatible{" "}
              <strong>iCalendar (.ics)</strong> file containing release years and target dates for
              all games in this view.
            </p>
