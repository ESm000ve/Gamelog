...
const SEED_GAMES: Game[] = [
  {
    ...
    releaseYear: 2022,
    summary:
      "A vast open-world action RPG set in the Lands Between — FromSoftware's most ambitious work yet.",
    genres: ["Action RPG", "Soulslike", "Open World"],
    platforms: ["PC", "PS5", "Xbox Series X|S"],
    coverColor: "#2a1f2e",
    timeToBeat: { average: 56, finish: 78, master: 133 },
    addedAt: addedAt(16),
    updatedAt: addedAt(16),
  },
  {
    igdbId: 2,
    title: "Hades",
  ...
  },
  {
    ...
    releaseYear: 2019,
    summary:
      "An exploration game set in a handcrafted solar system stuck in a 22-minute time loop.",
    genres: ["Adventure", "Exploration", "Mystery"],
    platforms: ["PC", "PS4", "Xbox One"],
    coverColor: "#29231a",
    timeToBeat: { average: 14, finish: 17, master: 26 },
    addedAt: addedAt(11),
    updatedAt: addedAt(11),
  },
  {
    igdbId: 7,
    title: "Celeste",
  ...
  },
  {
    ...
    releaseYear: 2022,
    summary:
      "A fox explores a mysterious world armed with an in-game instruction manual in an invented language.",
...
function makeLog(
  ...
  opts?: {
    ...
    ownership?:
      ...
      | "Subscription"
      | "Borrowed"
      | ("Physical" | "Digital" | "Subscription" | "Borrowed")[];
    notes?: string;
  }
): Log {
  const now = Date.now();
...
const SEED_LOGS: Log[] = [
  makeLog(1, "Played", {
    ...
    finishedAt: "May 12, 2026",
    ownership: "Digital",
    notes:
      "Finally got around to it. The open world removes the friction I always bounced off in previous FromSoft games — being able to go somewhere else when a boss wrecked me kept me moving forward. Malenia took three evenings. Worth every second.",
  }),
  makeLog(2, "Played", {
    completion: "Completed",
    rating: 4.5,
    platform: "PC",
    timePlayed: "47h",
    startedAt: "Mar 2, 2026",
    finishedAt: "Apr 18, 2026",
    ownership: "Digital",
    notes:
      "Picked this up on a whim during a sale and did not expect to lose three weeks to it. The loop is basically perfect — every failed run still moves something forward.",
  }),
  makeLog(3, "Playing", {
    platform: "PC",
    timePlayed: "32h",
    ...
    notes:
      "Halfway through and already certain this is something special. The skill system as character psychology is unlike anything else.",
  }),
  makeLog(4, "Playing", {
    platform: "PC",
    timePlayed: "60h",
    startedAt: "Nov 5, 2025",
    notes:
      "Act 2 is phenomenal. Party banter on long rests is some of the best character writing in games.",
  }),
  makeLog(5, "Backlog"),
  makeLog(6, "Backlog"),
  makeLog(7, "Played", {
    ...
    platform: "Switch",
    timePlayed: "28h",
    startedAt: "Sep 1, 2025",
    finishedAt: "Sep 22, 2025",
    notes:
      "The B-side levels are among the most satisfying hard content I've played. Chapter 9 felt impossible until it suddenly wasn't.",
  }),
  makeLog(8, "Wishlist"),
  makeLog(9, "Playing", {
    platform: "PC",
    timePlayed: "18h",
    startedAt: "Apr 20, 2026",
    notes:
      "Early Access but incredibly polished. The new weapon movesets feel distinct in a way the first game's didn't always manage.",
  }),
  makeLog(10, "Played", {
    completion: "Completed",
    rating: 4.0,
    platform: "PC",
    timePlayed: "200h",
    startedAt: "Mar 15, 2025",
    finishedAt: "Oct 2, 2025",
    ownership: "Digital",
    notes:
      "Lost count of how many evenings disappeared into this. The multiplayer co-op farm with a friend was a highlight of last year.",
  }),
  makeLog(11, "Played", {
    completion: "Completed",
    rating: 3.5,
    platform: "PC",
    timePlayed: "65h",
    startedAt: "Dec 1, 2025",
    finishedAt: "Feb 14, 2026",
    notes:
      "Came back after the 2.0 patch and finally got what the hype was about. The last act hit hard. City design is still the best in the genre.",
  }),
  makeLog(12, "Played", {
    completion: "Completed",
    rating: 4.5,
    platform: "PC",
    timePlayed: "12h",
    startedAt: "Oct 10, 2025",
    finishedAt: "Oct 17, 2025",
    notes:
      "Solved it in a week of evenings. The moment the last cluster of fates clicked into place was one of the best feelings a game has given me.",
  }),
  makeLog(13, "Wishlist"),
  makeLog(14, "Backlog"),
  makeLog(15, "Backlog"),
