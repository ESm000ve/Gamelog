...
export function ContributionHeatmap({
  ...
  const getCellColor = (level: number, isSelected: boolean) => {
    ...
    switch (level) {
      case 1:
        return "rgba(48, 209, 88, 0.25)";
      case 2:
        return "rgba(48, 209, 88, 0.5)";
      case 3:
        return "rgba(48, 209, 88, 0.75)";
      case 4:
        return "var(--apple-accent)";
      default:
        return "var(--apple-tertiary-bg)";
    }
  };
    ...
    >
      ...
      >
        <div>
          ...
          >
            <Calendar size={18} color="var(--apple-accent)" aria-hidden="true" />
      ...
      >
        <div>
          {selectedDate ? (
            ...
            <span>
              ...
              <strong>{hoveredCell.displayDate}</strong>
            </span>
          ) : (
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          ...
          />
          <div
            style={{ width: 10, height: 10, borderRadius: 2, background: "rgba(48, 209, 88, 0.5)" }}
          />
          <div
            style={{
              width: 10,
          ...
          />
          <div
            style={{ width: 10, height: 10, borderRadius: 2, background: "var(--apple-accent)" }}
          />
          <span>More</span>
        </div>
      </div>
