...
export function SingleListScreen({ listId, onBack, onOpenGame }: SingleListScreenProps) {
  ...
  const shareOpen = searchParams.get("share-list") === "true";
              ...
              <>
                ...
                >
                  ...
                  {confirmDelete ? (
                    ...
                    >
                      <span style={{ fontSize: 11, color: "var(--apple-red)" }}>
                        Delete this list?
                      </span>
              ...
              {(searchResults ?? []).map((g) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p style={{ fontSize: 11, color: "var(--apple-tertiary-label)" }}>
                      {g.releaseYear}
                    </p>
                  </div>
                  <Plus
                    size={14}
                    style={{ marginLeft: "auto", color: "var(--apple-accent)", flexShrink: 0 }}
                  />
                </Button>
              ))}
            </div>
              ...
              >
                ...
                <Button
                  ...
                  onMouseLeave={(e) => {
                    ...
                    e.currentTarget.style.color = "var(--apple-tertiary-label)";
                  }}
                >
                  <Trash2 size={13} />
                </Button>
          ...
          >
            {gamesList.map((game) => (
              <UnrankedCard
                key={game.igdbId}
                game={game}
                onOpen={() => onOpenGame(game.igdbId)}
                onRemove={() => removeGame(game.igdbId)}
              />
            ))}
          </div>
        )}
    ...
    >
      <div
        style={{
          ...
          alignItems: "center",
          gap: 8,
          padding: "var(--space-3) 300px var(--space-3) var(--space-5)",
  ...
  return (
    <Button
      ...
      style={{
        ...
        minHeight: 44,
        fontSize: "var(--font-size-base)",
        color: danger ? "var(--apple-red)" : "var(--apple-label)",
        background: "transparent",
        textAlign: "left",
      }}
      onMouseEnter={(e) => (e.currentTarget.style.background = "var(--apple-fill)")}
