        ...
        {!stats ? (
          ...
          >
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 4 }}>
              ...
              <p style={{ color: "var(--apple-tertiary-label)", fontSize: "var(--font-size-sm)" }}>
                Add some games to your library to see your stats.
              </p>
            </div>
          </div>
        ) : (
          <>
            ...
            >
              <div
                style={{
                  ...
                  borderBottom: insights.length > 0 ? "1px solid var(--apple-separator)" : "none",
                }}
              >
                <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                  ...
                  <div>
                    ...
                    >
                      AI-generated observations on your gaming habits.
                    </p>
                  </div>
                </div>
                <Button
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 20 }}>
              <ChartSection
                title="Backlog Burndown (Last 12 Months)"
                icon={<BarChart2 size={16} aria-hidden="true" />}
              >
                <VerticalBarChart
                  data={stats.burndownData}
                  height={180}
