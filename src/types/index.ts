...
export type Status = "Wishlist" | "Backlog" | "Playing" | "Played";

export type Completion = "Completed" | "Mastered" | "Abandoned" | "Shelved";

export type Ownership = "Physical" | "Digital" | "Subscription" | "Borrowed";
